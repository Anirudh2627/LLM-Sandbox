...
Local testing with Redis enabled produced approximately:

| Metric | Result |
|---|---:|
| Cache Hit Rate | ~82% |
| Cached Response Latency | ~12 ms |
| LLM Response Latency | ~680 ms |
| Guardrail Overhead | <0.5 ms |
| Rate Limit Accuracy | 100% |

> Results depend on hardware, network conditions, Redis configuration, and LLM response time.
